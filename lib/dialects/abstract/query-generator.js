  ...
  */
  quote(collection, parent, connector) {
    ...
    if (typeof collection === 'string') {
      ...
      let errorMessage = 'Unknown structure passed to order / group: ';
      if (collection instanceof Association) {
        // For associations, use a more readable format (association name or target model name)
        errorMessage += collection.as || collection.target.name;
      } else {
        errorMessage += util.inspect(collection);
      }
