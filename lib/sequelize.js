...
class Sequelize {
  ...
  query(sql, options) {
    ...
    return Promise.try(() => {
      ...
      // CVE-2023-25813: safe injection skipping strings/comments (commits 87a6123, ccaa399)
      // NOTE: Prior to this fix, untrusted user-supplied values could be injected into SQL even inside strings/comments,
      // leading to SQL injection vulnerability. See: https://github.com/sequelize/sequelize/security/advisories/GHSA-5jq9-jmwh-4rfv
      if (options.replacements) {
        sql = Utils.injectReplacements(sql, this.options.dialect, options.replacements);
      }
