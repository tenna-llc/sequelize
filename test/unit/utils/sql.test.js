const injectReplacements = require('../../../lib/utils/sql').injectReplacements;
...
describe('injectReplacements (positional replacements)', () => {
  ...
  it('does not parse ?& and ?| operators as replacements (#14358)', () => {
    ...
    expectsql(sql, {
      ...
      postgres: 'SELECT * FROM products WHERE tags ?& ARRAY[1] AND tags ?| ARRAY[1] AND id = 1;',
  ...
  it('formats arrays as an expression instead of an ARRAY data type', () => {
